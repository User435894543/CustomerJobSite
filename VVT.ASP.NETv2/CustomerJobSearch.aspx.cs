...
namespace VVT.ASP.NETv2
{
    public partial class CustomerJobSearch : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region old code query taken out and xml fill instead
            ...
            //here is where use if statements for what customer login in used for session^

            //strategic marketing
            if (user == "SM" || user == "kj") { 
                    dataSet.ReadXml(@"\\visonas\public\Kyle\CustomerSite\1781 SM/1781_data.xml");
                }
            ...
            rowCount = dataSet.Tables["Table1"].Rows.Count;
        ...
        public void Refresh_Click(object sender, EventArgs e)
        {
            ...
            #region old code use xml fill instead
